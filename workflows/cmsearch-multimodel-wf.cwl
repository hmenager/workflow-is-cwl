...
steps:
  - id: cmsearch
    ...
    out:
      - id: matches
      - id: programOutput
    run: /home/vagrant/snapshot/workflow-is-cwl/tools/Infernal/cmsearch/infernal-cmsearch-v1.1.2.cwl
  ...
  - id: concatenate_matches
    ...
    out:
      - id: result
    run: /home/vagrant/snapshot/workflow-is-cwl/utils/concatenate.cwl
  - id: remove_overlaps
    in:
      - id: clan_information
        source: clan_info
    ...
    out:
      - id: deoverlapped_matches
    run: /home/vagrant/snapshot/workflow-is-cwl/tools/cmsearch-deoverlap/cmsearch-deoverlap-v0.02.cwl
